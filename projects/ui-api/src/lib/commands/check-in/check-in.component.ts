...
import { concatMap, switchMap, map, finalize } from 'rxjs/operators';
...
export class CheckInComponent implements OnInit {
  ...
  qualifiedUsersBuildingList = {
    id: 'building_list',
    name: '- ' + this.locale.resourceStrings['COMBO_BOX_BUILDING_LIST'] + ' -'
  };
  // Create a 'pick one' item.
  qualifiedUsersPickOne = {
    id: 'pick_one', name: '- ' + this.locale.resourceStrings['COMBO_BOX_PICK_ONE'] + ' -'
  };
  // Create a '' item.
  qualifiedUsersBlank = {
    id: '',
